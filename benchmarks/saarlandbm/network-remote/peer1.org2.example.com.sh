...
docker run -it \
           ...
           -e CORE_PEER_NETWORKID=peer1.org2.example.com \
           ...
           -v $(pwd)/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp:/etc/hyperledger/fabric/msp \
           -w /opt/gopath/src/github.com/hyperledger/fabric/peer \
           hail05:5000/peer:local \
           peer node start 2>&1 \
    | tee /var/nfs/logs/peer1-org2.log
